...
// Constructor implicit pentru Client.Apeleaza constructorul implicit din Utilizator si seteaza adresa de livrare ca "necunoscuta". 
Client::Client()
    : Utilizator(), m_adresa_livrare("necunoscuta") {}

// Constructor cu parametri pentru Client.Initializeaza campurile mostenite si adresa de livrare.
